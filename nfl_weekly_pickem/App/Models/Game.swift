...
class Game {
    ...
    init(json: [String: Any]) {
        let gameInfoValue = json["game_info"] as! [String: Any]
        gameInfo = GameInfo(json: gameInfoValue)
        
        awayTeam = Team.teamType(for: gameInfoValue["away_team_name"] as! String)
        homeTeam = Team.teamType(for: gameInfoValue["home_team_name"] as! String)
        
        awayTeamStat = TeamStat(json: json["away_team_stats"] as! [String: Any])
        homeTeamStat = TeamStat(json: json["home_team_stats"] as! [String: Any])
    }
}
